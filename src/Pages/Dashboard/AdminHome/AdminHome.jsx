    ...
    <div className="ml-8 mt-12">
      ...
      <div className="grid md:grid-cols-4 grid-cols-1 gap-6 mt-6">
        <div className="stats shadow bg-gradient-to-r from-[#BB34F5] to-[#FCDBFF] rounded-lg">
          <div className="stat px-8 flex justify-center items-center">
            <div className="">
            ...
            <div className="">
              ...
              <div className="text-slate-900 text-sm">revenue</div>
            </div>
          </div>
        </div>
        <div className="stats shadow bg-gradient-to-r from-[#D3A256] to-[#FDE8C0] rounded-lg">
          <div className="stat px-8 flex justify-center items-center">
            ...
            <div className="">
              <div className="stat-value text-center">{adminStats.users}</div>
              <div className="text-slate-900 text-sm">customers</div>
            </div>
          </div>
        </div>
        <div className="stats shadow bg-gradient-to-r from-[#FE4880] to-[#FECDE9] rounded-lg">
          <div className="stat px-8 flex justify-center items-center">
            ...
            <div className="">
              ...
              <div className="text-slate-900 text-sm">products</div>
            </div>
          </div>
        </div>
        <div className="stats shadow bg-gradient-to-r from-[#6AAEFF] to-[#B6F7FF] rounded-lg">
          <div className="stat px-8 flex justify-center items-center">
            ...
            <div className="">
              <div className="stat-value text-center">{adminStats.orders}</div>
              <div className="text-slate-900 text-sm">orders</div>
            </div>
          </div>
        </div>
      </div>
